C and Python implementation of the paper "Stealing Model Parameters via Side Channel Power Attacks" (ISVLSI-2021)[[Link]](https://ieeexplore.ieee.org/document/9516772), and the paper "Training Privacy-Preserving Deep Neural Networks under Side-Channel Power Attacks" (Update later).
